...
//       return;
//     }
//     const receiverId = selectedUser.id; // Or selectedUser._id if the backend uses _id
//     const parsedReceiverId = parseInt(receiverId);
//     if (!receiverId || isNaN(parsedReceiverId)) {
//       toast.error('Invalid receiver ID');
//       return;
//     }
//     const result = await handleSendMessage(parsedReceiverId, messageInput, token);
//     if (result.success) {
//       setMessageInput('');
//     } else {
//       toast.error(result.error);
...
//               <div
//                 key={user.id} // Or user._id if applicable
//                 onClick={() => {
...
//                   onKeyPress={(e) => e.key === 'Enter' && sendMessage()} // Fixed onClick to onKeyPress
//                 />
//                 <button
//                   onClick={sendMessage}
