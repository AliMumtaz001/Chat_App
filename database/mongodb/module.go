...
type Storage interface {
	...
	UpdateMessagedb(c *gin.Context, messageID primitive.ObjectID, message models.Message, userID string) error
	DeleteMessagedb(c *gin.Context, messageID primitive.ObjectID, userID string) error
}
